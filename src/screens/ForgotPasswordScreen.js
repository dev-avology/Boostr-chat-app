  ...
  return (
    ...
    <View style={styles.container}>
      <View style={styles.card}>
       <Image source={require('../assets/logo.png')} // Replace with your logo image
          style={styles.logo}/>
        ...
        <TouchableOpacity onPress={handleGooglesignIn} style={styles.forgotPasswordMain}>
          <Text style={styles.forgotPassword}>Remember your password? Log in</Text>
        </TouchableOpacity>
      </View>
    </View>
    </ImageBackground>
