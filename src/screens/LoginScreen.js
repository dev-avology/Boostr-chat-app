        ...
        <View style={styles.container}>
          ...
          <View style={styles.card}>
            <Text style={[styles.smallText, styles.forText]}>
              Login with your Booostr user account to begin chatting with your team in real-time!
            </Text>
            <TextInput
              style={styles.input}
              placeholder="Email"
            ...
            <TouchableOpacity onPress={handleForgotPassword} style={styles.forgotPasswordMain}>
              <Text style={styles.forgotPassword}>Forgot your password?</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.BottomText}>
            <Text style={[styles.smallText, styles.ForWidth]}>
              To access Booostr Team Chat for your organization, you need to have a Booostr user account. If you do not have a Booostr user account but need to connect with a club or nonprofit using Booostr Team Chat, you can
              <Text style={styles.BlueText} onPress={() => Linking.openURL('https://example.com')}>
